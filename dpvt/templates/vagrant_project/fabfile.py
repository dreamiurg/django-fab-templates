...
env.project_name = 'vecherkom'
    
def _set_webfaction_env():
    env.python = 'python2.7'
    env.repo_url = "git@dreamiurg.unfuddle.com:dreamiurg/vecherkom.git"
...
def staging():
    ...
    env.webfaction_appname = 'malcolm'
    env.hosts = ['web120.webfaction.com']
    _set_webfaction_env()
...
def production():
    ...
    env.webfaction_username = 'dreamiurg'
    env.webfaction_appname = 'nonexistent'
    env.hosts = ['web120.webfaction.com']
    _set_webfaction_env()
